...
func resourceClientVPNNetworkAssociationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	targetNetwork, err := tfec2.WaitClientVPNNetworkAssociationAssociated(conn, d.Id(), d.Get("client_vpn_endpoint_id").(string))
	if err != nil {
...
func deleteClientVpnNetworkAssociation(conn *ec2.EC2, networkAssociationID, clientVpnEndpointID string) error {
	...
	_, err = tfec2.WaitClientVPNNetworkAssociationDisassociated(conn, networkAssociationID, clientVpnEndpointID)
